...
//import io.lettuce.core.awaitSuspended
...
//            val playerRecord = Converter.playerTypeToStringRepresentation(player)
//
//            asyncCommands.del("$gameID:moves:X", "$gameID:moves:O")
//            asyncCommands.hdel("$gameID:info", "winner")
...
//
//            withContext(Dispatchers.IO) {
//                asyncCommands.sadd("$gameID:moves:${move.player}", moveRecord).await()
//            }
//
//            val xMoves = withContext(Dispatchers.IO) {
//                asyncCommands.smembers("$gameID:moves:X").await().map { position ->
//                    CellPosition.valueOf(position)
//                }
//            }
//
//            val oMoves = withContext(Dispatchers.IO) {
//                asyncCommands.smembers("$gameID:moves:O").await().map { position ->
//                    CellPosition.valueOf(position)
//                }
//            }
//
...
//        return try {
//
//            val playerMoves = asyncCommands.smembers("$gameID:moves:${move.player}")
//
...
//        return try {
//
//            val info = asyncCommands.hmget("$gameID:info", "currentPlayer", "gameState", "winner")
//            val xMoves = asyncCommands.smembers("$gameID:moves:X").map { position -> Converter.stringToCellPosition(position) }
//            val oMoves = asyncCommands.smembers("$gameID:moves:O").map { position -> Converter.stringToCellPosition(position) }
//
